...
import org.terraform.cave.TerrainControlSmallLakeGen;
...
public class TerraformGenerator extends ChunkGenerator {
    ...
    private static final TerrainControlSmallLakeGen TERRAIN_CONTROL_SMALL_LAKE_GEN = new TerrainControlSmallLakeGen();
                              ...
                              @NotNull ChunkData chunkData)
    {
        ...
        TERRAIN_CONTROL_SMALL_LAKE_GEN.populate(tw, chunkX, chunkZ, chunkData, cache);
